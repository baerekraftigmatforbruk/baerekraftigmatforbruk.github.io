...
text3718.rcdData.att_TabletLandscape = 
{
    ...
    text3707.changeContents( "" +  Oppgaver_Score.getValueForDisplay() + "" ); 
    if(typeof pF == 'function') pF(); }}
	]
	},
